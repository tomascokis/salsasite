...
declare module "$app/types" {
	...
	export interface AppTypes {
		RouteId(): "/" | "/api" | "/api/clips" | "/api/clips/[clipId]" | "/api/clips/[clipId]/key" | "/api/dancers" | "/api/media" | "/api/media/library" | "/api/metadata" | "/api/moves" | "/api/moves/create" | "/api/moves/[...id]" | "/api/posters" | "/api/posters/[...path]" | "/api/search" | "/api/upload" | "/api/upload/clips" | "/api/upload/library" | "/api/upload/publish" | "/api/upload/render" | "/api/upload/source" | "/api/upload/source/[id]" | "/api/upload/source/[id]/detect-fields" | "/dancers" | "/families" | "/families/[slug]" | "/media" | "/media/edit" | "/media/edit/[id]" | "/media/[...path]" | "/moves" | "/moves/create" | "/moves/create/metadata" | "/moves/[slug]" | "/moves/[slug]/edit" | "/posters" | "/posters/[...path]" | "/progress" | "/progress/editor" | "/settings" | "/settings/pickers" | "/topics" | "/topics/[slug]" | "/upload";
		RouteParams(): {
		...
		Pathname(): "/" | `/api/clips/${string}/key` & {} | "/api/dancers" | "/api/media/library" | "/api/metadata" | "/api/moves/create" | `/api/moves/${string}` & {} | `/api/posters/${string}` & {} | "/api/search" | "/api/upload/clips" | "/api/upload/library" | "/api/upload/publish" | "/api/upload/render" | "/api/upload/source" | `/api/upload/source/${string}` & {} | `/api/upload/source/${string}/detect-fields` & {} | "/dancers" | `/families/${string}` & {} | "/media" | `/media/edit/${string}` & {} | `/media/${string}` & {} | "/moves/create" | "/moves/create/metadata" | `/moves/${string}` & {} | `/moves/${string}/edit` & {} | `/posters/${string}` & {} | "/progress" | "/progress/editor" | "/settings" | "/settings/pickers" | `/topics/${string}` & {} | "/upload";
