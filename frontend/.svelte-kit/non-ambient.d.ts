...
declare module "$app/types" {
	...
	export interface AppTypes {
		...
		LayoutParams(): {
			"/": { id?: string; path?: string; slug?: string };
		...
		Pathname(): "/" | "/api/dancers" | "/api/media/library" | "/api/metadata" | "/api/moves/create" | `/api/moves/${string}` & {} | `/api/posters/${string}` & {} | "/api/search" | "/api/upload/clips" | "/api/upload/library" | "/api/upload/publish" | "/api/upload/render" | "/api/upload/source" | `/api/upload/source/${string}` & {} | `/api/upload/source/${string}/detect-fields` & {} | "/dancers" | `/families/${string}` & {} | "/media" | `/media/edit/${string}` & {} | `/media/${string}` & {} | "/moves/create" | "/moves/create/metadata" | `/moves/${string}` & {} | `/moves/${string}/edit` & {} | `/posters/${string}` & {} | "/progress" | "/progress/editor" | "/settings" | `/topics/${string}` & {} | "/upload";
